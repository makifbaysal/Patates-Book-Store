                            ...
                            child: ListView(
                              ...
                              children: <Widget>[
                                ...
                                PTextField(
                                    ...
                                    validator: (value) {
                                      if (value.isEmpty) {
                                        return FlutterI18n.translate(context, "SignUp.ErrorMessages.email.pleaseEnterEmail");
                                      }
                                      Pattern pattern =
                                ...
                                SizedBox(height: 28),
                                Text(FlutterI18n.translate(context, "SignUp.phone"), style: FontStyles.bigTextField(textColor: PColors.white)),
                                SizedBox(height: 8),
                                PTextField(
                                    focusNode: phoneFocusNode,
                                    controller: phoneController,
                                    keyboardType: TextInputType.number,
                                    placeholderText: FlutterI18n.translate(context, "SignUp.enterPhone"),
                                    validator: (value) {
                                      if (value.isEmpty) {
                                        return FlutterI18n.translate(context, "SignUp.pleaseEnterPhone");
                                      }
                                      Pattern pattern = r'^(05(\d{9}))$';
                                      RegExp regex = new RegExp(pattern);
                                      if (!regex.hasMatch(value)) return FlutterI18n.translate(context, "SignUp.pleaseEnterValidPhone");
                                    }),
                              ],
                            ),
                          ),
