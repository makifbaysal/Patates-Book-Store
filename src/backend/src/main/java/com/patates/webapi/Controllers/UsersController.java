...
public class UsersController {
  private final FirebaseUserService userServices;

  public UsersController(FirebaseUserService userServices) {
    this.userServices = userServices;
  }

  @RequestMapping(value = "/create", method = RequestMethod.POST)
  public CreateUserOutputDTO createUser(@RequestBody CreateUserInputDTO user)
  ...
  public String resetUserPasswordUpdate(@RequestBody PasswordResetInputDTO email)
  ...
  public String updateUserPassword(@RequestBody UpdatePasswordInputDTO user)
      throws IOException, JSONException {
  ...
  public UserDetailsOutputDTO getUserDetail(
  ...
  public String addToBookmark(@RequestBody AddBookmarkInputDTO addBookmarkInputDTO)
      throws ExecutionException, InterruptedException {
    return userServices.addToBookmark(addBookmarkInputDTO);
  }

  @RequestMapping(value = "/deleteFromBookmark", method = RequestMethod.POST)
  public String deleteFromBookmark(@RequestBody DeleteBookmarkInputDTO deleteBookmarkInputDTO)
      throws ExecutionException, InterruptedException {
    return userServices.deleteFromBookmark(deleteBookmarkInputDTO);
  }

  @RequestMapping(value = "/getBookmark", method = RequestMethod.POST)
  public List<ProductListingOutputDTO> getBookmark(@RequestParam(value = "userId") String userId)
      throws ExecutionException, InterruptedException {
    return userServices.getBookmark(userId);
  }

  @RequestMapping(value = "/addToShoppingCart", method = RequestMethod.POST)
  public String addToShoppingCart(@RequestBody AddToShoppingCartInputDTO addToShoppingCartInputDTO)
      throws ExecutionException, InterruptedException {
    return userServices.addToShoppingCart(addToShoppingCartInputDTO);
  }

  @GetMapping(value = "/getShoppingCart")
  public List<ShoppingCartProductListingOutputDTO> getShoppingCart(@RequestParam String userId)
      throws ExecutionException, InterruptedException {
  ...
  public String updateShoppingCart(
      @RequestBody UpdateShoppingCartInputDTO updateShoppingCartInputDTO)
      throws ExecutionException, InterruptedException {
  ...
  public String deleteProductShoppingCart(
      @RequestBody DeleteProductShoppingCartInputDTO deleteProductShoppingCartInputDTO) {
  ...
  public List<ListAddressOutputDTO> getAddresses(@RequestParam String userId)
      throws ExecutionException, InterruptedException {
    return userServices.getAddresses(userId);
  }

  @GetMapping(value = "/addressDetails")
  public AddressDetailsOutputDTO addressDetails(
      @RequestParam String userId, @RequestParam String adressId)
      throws ExecutionException, InterruptedException {
    return userServices.addressDetails(userId, adressId);
  }

  @RequestMapping(value = "/addCreditCart", method = RequestMethod.POST)
  public String addCreditCart(@RequestBody AddCreditCartInputDTO addCreditCartInputDTO)
      throws ExecutionException, InterruptedException {
    return userServices.addCreditCart(addCreditCartInputDTO);
  }

  @RequestMapping(value = "/updateCreditCart", method = RequestMethod.POST)
  public String updateCreditCart(@RequestBody UpdateCreditCartInputDTO updateCreditCartInputDTO)
      throws ExecutionException, InterruptedException {
  ...
  public String deleteCreditCart(@RequestBody DeleteCreditCartInputDTO deleteCreditCartInputDTO)
      throws ExecutionException, InterruptedException {
    return userServices.deleteCreditCart(deleteCreditCartInputDTO);
  }

  @GetMapping(value = "/getCreditCarts")
  public List<ListCreditCartsOutputDTO> getCreditCarts(@RequestParam String userId)
      throws ExecutionException, InterruptedException {
    return userServices.getCreditCarts(userId);
  }

  @GetMapping(value = "/creditCartDetails")
  public CreditCartDetailsOutputDTO creditCartDetails(
      @RequestParam String userId, @RequestParam String cartId)
      throws ExecutionException, InterruptedException {
  ...
  public CommentDetailsOutputDTO commentDetail(
      @RequestBody CommentDetailsInputDTO commentDetailsInputDTO)
      throws ExecutionException, InterruptedException {
    return userServices.commentDetail(commentDetailsInputDTO);
  }

  @RequestMapping(value = "/deleteComment", method = RequestMethod.POST)
  public String deleteComment(@RequestBody DeleteCommentInputDTO deleteCommentInputDTO)
      throws ExecutionException, InterruptedException {
    return userServices.deleteComment(deleteCommentInputDTO);
  }

  @RequestMapping(value = "/updateComment", method = RequestMethod.POST)
  public String updateComment(@RequestBody UpdateCommentInputDTO updateCommentInputDTO)
      throws ExecutionException, InterruptedException {
    return userServices.updateComment(updateCommentInputDTO);
  }

  @GetMapping(value = "/getUserComments")
  public List<UserCommentOutputDTO> getUserComments(@RequestParam String userId)
      throws ExecutionException, InterruptedException {
  ...
  public UseCouponCodeOutputDTO useCouponCode(@RequestParam String code)
      throws ExecutionException, InterruptedException {
    return userServices.useCouponCode(code);
  }

  @RequestMapping(value = "/sendMessage", method = RequestMethod.POST)
  public String sendMessage(@RequestBody SendMessageInputDTO sendMessageInputDTO)
      throws ExecutionException, InterruptedException {
