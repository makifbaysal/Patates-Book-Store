...
public class ShippingCompanyController {
  ...
  @RequestMapping(
      ...
      value = "/addShippingCompany",
      method = RequestMethod.POST)
  @CacheEvict(value = "getShippingCompanies", allEntries = true)
  public String addShippingCompany(
      @RequestParam("file") MultipartFile file,
      @RequestParam String website,
      @RequestParam double price,
      @RequestParam String name,
      @RequestParam("date") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date endDate,
      @RequestParam String contactNumber)
      throws IOException {
    return shippingCompanyService.addShippingCompanies(
        file, website, price, name, endDate, contactNumber);
  }
  ...
  @RequestMapping(
      consumes = MediaType.MULTIPART_FORM_DATA_VALUE,
      value = "/updatePhotoShippingCompany",
      method = RequestMethod.POST)
  @CacheEvict(value = "getShippingCompanies", allEntries = true)
  public String updatePhotoShippingCompany(
      @RequestParam("file") MultipartFile file, @RequestParam String companyId)
  ...
  public List<ListingShippingCompaniesOutputDTO> getShippingCompanies(
  ...
  public ShippingCompanyDetailsOutputDTO getShippingCompanyDetails(
