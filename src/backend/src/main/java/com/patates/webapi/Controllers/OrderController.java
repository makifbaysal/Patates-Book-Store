...
public class OrderController {
  ...
  public OrderDetailsOutputDTO orderDetails(
  ...
  public String cancelOrder(@RequestBody CancelOrderInputDTO cancelOrderInputDTO)
      throws ExecutionException, InterruptedException {
    return orderService.cancelOrder(cancelOrderInputDTO);
  }

  @RequestMapping(value = "/acceptOrder", method = RequestMethod.POST)
  public String acceptOrder(@RequestBody AcceptOrderInputDTO acceptOrderInputDTO)
      throws ExecutionException, InterruptedException {
    return orderService.acceptOrder(acceptOrderInputDTO);
  }

  @RequestMapping(value = "/refundOrder", method = RequestMethod.POST)
  public String refundOrderRequest(@RequestBody RefundOrderInputDTO refundOrderInputDTO)
      throws ExecutionException, InterruptedException {
