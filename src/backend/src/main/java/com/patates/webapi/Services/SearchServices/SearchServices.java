...
public interface SearchServices {
    ...
    String getProductElasticQuery(int size, int from, int lowestPage, int highestPage, ArrayList<String> category, ArrayList<String> languages, int lowestPrice, int highestPrice, String sort, String search);
    ...
    boolean addProduct(String productId, CreateProductOutputDTO createProductOutputDTO) throws JsonProcessingException;
    ...
    ProductDetailOutputDTO getProductDetails(boolean bookmark, String productId, int commentCount, double star, int stock);
