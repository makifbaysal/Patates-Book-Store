...
public class FirebaseUserService implements UserServices {
    ...
    FirebasePhotoService firebasePhotoService = new FirebasePhotoService();
    ...
    */
    public String resetPassword(String email) throws UnsupportedEncodingException, ExecutionException, InterruptedException {
    ...
    public String update(String email, String idToken) throws UnsupportedEncodingException {
        HttpPost post = new HttpPost("https://identitytoolkit.googleapis.com/v1/accounts:update?key=APIKEY");
    ...
    public String updateUserPassword(UpdatePasswordInputDTO user) throws IOException, JSONException {
        ...
        LoginOutputDTO login = login(new LoginInputDTO(getEmailFromIdToken(user.getIdToken()), user.getOldPassword()));
    ...
    public String uploadImage(MultipartFile file, String userId) throws IOException, ExecutionException, InterruptedException {
    ...
    public UserDetailsOutputDTO getUserDetail(String userId) throws ExecutionException, InterruptedException {
        return userRepository.getUserDetail(userId);
    }

    public String addToBookmark(AddBookmarkInputDTO addBookmarkInputDTO) throws ExecutionException, InterruptedException {
        return userRepository.addToBookmark(addBookmarkInputDTO.getUserId(), addBookmarkInputDTO.getProductId());
    }

    public String deleteFromBookmark(DeleteBookmarkInputDTO deleteBookmarkInputDTO) throws ExecutionException, InterruptedException {
        return userRepository.deleteFromBookmark(deleteBookmarkInputDTO.getUserId(), deleteBookmarkInputDTO.getProductId());
    }
    ...
    public AddressDetailsOutputDTO addressDetails(String userId, String adressId) throws ExecutionException, InterruptedException {
        return userRepository.addressDetails(userId, adressId);
    }

    public String addCreditCart(AddCreditCartInputDTO addCreditCartInputDTO) throws ExecutionException, InterruptedException {

        String cartStatus = userRepository.creditCartExists(addCreditCartInputDTO.getCartNumber(), addCreditCartInputDTO.getOwner(), addCreditCartInputDTO.getDate(), addCreditCartInputDTO.getCvc());
    ...
    public String updateCreditCart(UpdateCreditCartInputDTO updateCreditCartInputDTO) throws ExecutionException, InterruptedException {
        String cartStatus = userRepository.creditCartExists(updateCreditCartInputDTO.getCartNumber(), updateCreditCartInputDTO.getOwner(), updateCreditCartInputDTO.getDate(), updateCreditCartInputDTO.getCvc());
        if (cartStatus.equals("Error")) {
            return "Error";
        } else {
    ...
    public String deleteCreditCart(DeleteCreditCartInputDTO deleteCreditCartInputDTO) throws ExecutionException, InterruptedException {
    ...
    public String makeComment(MakeCommentInputDTO makeCommentInputDTO) throws ExecutionException, InterruptedException {
