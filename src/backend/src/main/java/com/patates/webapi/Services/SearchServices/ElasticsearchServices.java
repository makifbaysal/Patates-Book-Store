...
public class ElasticsearchServices implements SearchServices {
    ...
    public String httpPostRequest(String query, String body) {
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() < 400) return EntityUtils.toString(response.getEntity());
    ...
    public String getProductElasticQuery(int size, int from, int lowestPage, int highestPage, ArrayList<String> category, ArrayList<String> languages, int lowestPrice, int highestPrice, String sort, String search) {
    ...
    public ProductListingReturnOutputDTO httpProductSearchRequest(String body) throws JSONException {
        ...
        ProductListingReturnOutputDTO productListingReturnOutputDTO = new ProductListingReturnOutputDTO();
        ...
        if (!strResponse.equals("Error")) {
            ...
            queryHit = new JSONObject(new JSONObject(new JSONObject(json.get("hits").toString()).get("total").toString()).toString()).getInt("value");
    ...
    public boolean addProduct(String productId, CreateProductOutputDTO createProductOutputDTO) throws JsonProcessingException {
    ...
    public ProductDetailOutputDTO getProductDetails(boolean bookmark, String productId, int commentCount, double star, int stock) {
