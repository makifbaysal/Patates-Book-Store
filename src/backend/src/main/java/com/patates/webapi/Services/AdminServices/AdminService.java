...
public class AdminService {
    ...
    public List<AdminGetUserDetailsOutputDTO> getUsers(String search) throws IOException, JSONException, ExecutionException, InterruptedException {
        List<UserDetailsOutputDTO> userDetails = elasticsearchServices.httpUserSearchRequest(search.toLowerCase(Locale.forLanguageTag("tr")));
        List<AdminGetUserDetailsOutputDTO> returnList = new ArrayList<>();
        for (UserDetailsOutputDTO user : userDetails) {
            AdminGetUserDetailsOutputDTO adminGetUserDetailsOutputDTO = new AdminGetUserDetailsOutputDTO();
    ...
    public String addCouponCode(CreateCouponInputDTO createCouponInputDTO) throws ExecutionException, InterruptedException, IOException, FirebaseMessagingException, ParseException {
    ...
    public String rejectOrder(RejectOrderInputDTO rejectOrderInputDTO) throws ExecutionException, InterruptedException {
    ...
    public String refundOrder(RefundOrderAdminInputDTO refundOrderAdminInputDTO) throws ExecutionException, InterruptedException {
